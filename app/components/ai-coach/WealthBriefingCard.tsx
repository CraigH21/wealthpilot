  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-zinc-900">Today&apos;s Wealth Briefing</h3>
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-black/10 bg-black/5 p-3">
          <p className="text-xs font-medium text-zinc-600">Net Worth Change</p>
        ...
        <div className="rounded-xl border border-black/10 bg-black/5 p-3">
          <p className="text-xs font-medium text-zinc-600">Biggest Winner</p>
          <p className="mt-1 text-lg font-semibold text-zinc-900">{briefing.biggestWinner.name}</p>
        ...
        <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 p-3">
          ...
          <p className="mt-1.5 text-sm leading-relaxed text-zinc-600">{briefing.biggestRisk}</p>
        </div>

        {briefing.goal && (
          <div className="rounded-xl border border-black/10 bg-black/5 p-3">
            <p className="text-xs font-medium text-zinc-600">{briefing.goal.name} Progress</p>
      ...
      <div className="mt-3 rounded-xl border border-black/10 bg-black/5 p-3">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-zinc-600">{briefing.recommendation}</p>
      </div>
    </section>
  );
}
